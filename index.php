...
foreach ($proList as  $product) {
	...
	echo '<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
		<div class="item-product">
			<div class="thumb">
				<a href="#"><img src="'.$product['linkImg'].'" alt=""></a>
				<span class="sale">Trả góp<br>'.$product['installment'].'%</span>
				<div class="action">
					<a href="cart.php" class="buy" onclick="moveIDtocart('.$product['id'].')"><i class="fa fa-cart-plus" ></i> Mua ngay</a>
